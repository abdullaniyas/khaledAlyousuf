    ...
    <body>
        ...
        <section class="margin-extra height-500">
            ...
            <div class="full-width pull-left">
                ...
                $result = mysqli_query($con, "SELECT banimage FROM  banners WHERE name='mobileacces' ORDER BY id DESC LIMIT 1");
                ...
                <div class="width-1100 center-div">
                    ...
                    <div class="full-width pull-left category-products">
                        ...
                        $result = mysqli_query($con, "SELECT * FROM  mobile WHERE deleted='false' and categoryeng='mobilestand' ORDER BY id DESC");
                        $target = "../images/products/mobile/";
                        $product = "mproduct.php?id=";
                        ?>
