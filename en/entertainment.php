    ...
    <body>
        ...
        <section class="margin-extra height-500">
            ...
            <div class="full-width pull-left">
                ...
                $result = mysqli_query($con, "SELECT banimage FROM  banners WHERE name='caracces' ORDER BY id DESC LIMIT 1");
                ...
                <div class="width-1100 center-div">
                    ...
                    <div class="full-width pull-left category-products">
                        <h1>Entertainment System</h1>
                        <?php
                        

                        $result = mysqli_query($con, "SELECT * FROM  car WHERE deleted='false' and categoryeng='entertainment' ORDER BY id DESC");
