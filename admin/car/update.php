...
if($_FILES['image']['name']=="") {
    $sql="UPDATE car SET ename = '".$ename."', aname = '".$aname."', categoryeng = '".$categoryeng."', showfront= '".$showfront."', edescription= '". addslashes($edescription) ."', adescription= '". addslashes($adescription) ."' WHERE id='".$did."'" ;
} else if($_FILES['image']['name']!=""){
    $sql="UPDATE car SET ename = '".$ename."', aname = '".$aname."', categoryeng = '".$categoryeng."', showfront= '".$showfront."', edescription= '". addslashes($edescription) ."', adescription= '". addslashes($adescription) ."', image = '".$ili."' WHERE id='".$did."'" ;
}
