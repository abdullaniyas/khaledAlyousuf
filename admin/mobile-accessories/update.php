...
if($_FILES['image']['name']=="") {
    $sql="UPDATE mobile SET ename = '".$ename."', aname = '".$aname."', categoryeng = '".$categoryeng."' WHERE id='".$did."'" ;
} else if($_FILES['image']['name']!=""){
    $sql="UPDATE mobile SET ename = '".$ename."', aname = '".$aname."', categoryeng = '".$categoryeng."', image = '".$ili."' WHERE id='".$did."'" ;
}
